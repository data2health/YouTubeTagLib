...
public class YouTubeTagLibTagSupport extends TagSupport {

    protected DataSource theDataSource = null;
    protected Connection theConnection = null;
    private static final Log log =LogFactory.getLog(YouTubeTagLibTagSupport.class);

    public YouTubeTagLibTagSupport() {
        super();
    }
